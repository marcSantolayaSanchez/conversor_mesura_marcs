...
def manejo_nivel():
    global BotonCelcius, BotonFahreinheit, Cursor
    if Nivel == 0:
    ...
    Cursor = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    BotonCelcius.set_position(26, 81)
    BotonFahreinheit.set_position(130, 81)
    ...
    if Nivel == 1:
        ...
        pass
Cursor: Sprite = None
BotonFahreinheit: Sprite = None
BotonCelcius: Sprite = None
Nivel = 0
opcio_usuari = 0
Nivel = 0
manejo_nivel()